...
import com.example.testsave.dao.CreateOnlineCarIndex;
import com.example.testsave.dao.OnlineCarIndexNameDao;
import com.example.testsave.domain.*;
    ...
    private void saveOnlinecarLog(JSONArray jsonArray) {
        ...
        for (UnitOnlinecarCarlog unitOnlinecarCarlog : unitOnlinecarCarlogs) {
            ...
            if (unitOnlinecarCarlogList.size() == 300 || temp >= unitOnlinecarCarlogs.size()) {
                ...
                //存储到es
                System.out.println(clientInterface.addDocuments(OnlineCarIndexNameDao.ONLINE_CAR_LOG_INDEX, "onlinecar_carlog", unitOnlinecarCarlogList));
